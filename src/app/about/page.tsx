...
const VALUES = [
    ...
    },
    {
        ...
        desc: "Hundreds of satisfied customers trust Bukhari for their travel needs every month.",
    },
];
        ...
        <>
            ...
            <div className={styles.page}>
                ...
                <div className={styles.heroBanner}>
                    ...
                    >
                        About <span className="gradient-text">Bukhari</span>
                    </motion.h1>
                    <motion.p
                ...
                <section className={styles.storySection}>
                    ...
                    >
                        ...
                        <p>
                            Bukhari Rent A Car was founded with a single vision: to bring luxury, reliability,
                            and professionalism to car rentals in Lahore. What started as a small fleet has grown
                        ...
                        <p>
                            ...
                            Bukhari ensures you arrive in style.
                        </p>
                        <p>
                ...
                <section className={styles.cta}>
                    ...
                    <p>Book your vehicle today and experience the Bukhari difference.</p>
